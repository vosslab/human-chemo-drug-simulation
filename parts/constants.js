...
var CHEMO_ORGAN_INFO = [
  {
    key: "bloodstream",
    label: "Bloodstream",
    role: "Carries the drug rapidly through the body right after dosing.",
  },
  {
    key: "liver",
    label: "Liver",
    role: "Breaks down and processes much of the chemotherapy burden.",
  },
  {
    key: "kidney",
    label: "Kidneys",
    role: "Clear water-soluble drug and metabolites from circulation.",
  },
...
var DRUG_DATA = {
  ...
  doxorubicin: {
    ...
    infusionHours: 1,
    description:
      "Anthracycline that intercalates DNA. " +
  ...
  cisplatin: {
    ...
    infusionHours: 2,
    description:
      "Platinum-based alkylating agent that crosslinks DNA. " +
  ...
  cyclophosphamide: {
    ...
    infusionHours: 1,
    description: "Nitrogen mustard prodrug activated by hepatic P450. " + "Half-life ~6 hours.",
  },
  bleomycin: {
    id: "bleomycin",
    name: "Bleomycin",
    ...
    infusionHours: 0.75,
    description:
      "Glycopeptide antibiotic causing DNA strand breaks. " +
  ...
  vinblastine: {
    ...
    infusionHours: 0.5,
    description:
      "Vinca alkaloid that inhibits microtubule assembly. " +
  ...
  dacarbazine: {
    ...
    infusionHours: 1.5,
    description: "Alkylating agent requiring hepatic activation. " + "Half-life ~5 hours.",
  },
  oxaliplatin: {
    id: "oxaliplatin",
    name: "Oxaliplatin",
  ...
  leucovorin: {
    ...
    infusionHours: 2,
    description:
      "Reduced folate that enhances 5-FU efficacy. " +
...
var REGIMEN_PRESETS = {
  ...
  bep: {
    ...
    doseDays: [0, 7, 14],
    description:
      "Bleomycin, Etoposide, Cisplatin. " + "First-line for testicular germ cell tumors.",
    teachingNotes: [
